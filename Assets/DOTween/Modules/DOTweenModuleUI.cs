...
using Outline1 = UnityEngine.UI.Outline;
...
namespace DG.Tweening
{
	public static class DOTweenModuleUI
    {
        ...
        /// <summary>Tweens a Outline1's effectColor to the given value.
        /// Also stores the Outline1 as the tween's target so it can be used for filtered operations</summary>
        /// <param name="endValue">The end value to reach</param><param name="duration">The duration of the tween</param>
        public static TweenerCore<Color, Color, ColorOptions> DOColor(this Outline1 target, Color endValue, float duration)
        {
        ...
        /// <summary>Tweens a Outline1's effectColor alpha to the given value.
        /// Also stores the Outline1 as the tween's target so it can be used for filtered operations</summary>
        /// <param name="endValue">The end value to reach</param><param name="duration">The duration of the tween</param>
        public static TweenerCore<Color, Color, ColorOptions> DOFade(this Outline1 target, float endValue, float duration)
        {
        ...
        /// <summary>Tweens a Outline1's effectDistance to the given value.
        /// Also stores the Outline1 as the tween's target so it can be used for filtered operations</summary>
        /// <param name="endValue">The end value to reach</param><param name="duration">The duration of the tween</param>
        public static TweenerCore<Vector2, Vector2, VectorOptions> DOScale(this Outline1 target, Vector2 endValue, float duration)
        {
